  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="grid grid-cols-2 gap-3">
        <div>
          <label className="mb-1 block text-sm font-medium text-neutral-700">Concepto</label>
          <select
            value={concepto}
        ...
        <div className="grid grid-cols-3 gap-3 rounded-md bg-neutral-50 p-3">
          <div>
            ...
            <input
              ...
              className="w-full rounded-md border border-neutral-300 px-2 py-2 text-sm outline-none focus:border-neutral-900"
            />
          </div>
          <div>
            <label className="mb-1 block text-xs font-medium text-neutral-600">
          ...
          {fieldErrors["fechaServicioDesde"] && (
            <p className="col-span-3 text-sm text-red-600">{fieldErrors["fechaServicioDesde"]}</p>
          )}
        </div>
      )}
      ...
      <div className="grid grid-cols-3 gap-3">
        ...
        <div>
          ...
          <input
            ...
            className="w-full rounded-md border border-neutral-300 px-3 py-2.5 text-base outline-none focus:border-neutral-900 disabled:bg-neutral-100"
          />
          {fieldErrors["docNro"] && <p className="mt-1 text-sm text-red-600">{fieldErrors["docNro"]}</p>}
        </div>
        <div>
          <label className="mb-1 block text-sm font-medium text-neutral-700">
            Nombre (opcional)
      ...
      <div>
        <label className="mb-2 block text-sm font-medium text-neutral-700">Ítems</label>
          ...
          {items.map((item, index) => (
            <div key={index} className="grid grid-cols-12 gap-2">
              <input
                ...
                className="col-span-6 rounded-md border border-neutral-300 px-3 py-2 text-sm outline-none focus:border-neutral-900"
              />
              <input
                value={item.cantidad}
                ...
                step="any"
                placeholder="Cant."
                className="col-span-2 rounded-md border border-neutral-300 px-2 py-2 text-sm outline-none focus:border-neutral-900"
              />
              <input
                ...
                step="any"
                placeholder="Precio"
                className="col-span-3 rounded-md border border-neutral-300 px-2 py-2 text-sm outline-none focus:border-neutral-900"
              />
              <button
                type="button"
        ...
        {fieldErrors["items"] && <p className="mt-1 text-sm text-red-600">{fieldErrors["items"]}</p>}
        <button
          type="button"
          onClick={addItem}
